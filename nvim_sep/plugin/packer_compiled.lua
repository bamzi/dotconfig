...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hop.nvim', 'vim-gist', 'numb.nvim', 'nvim-bqf', 'nvim-comment', 'diffview.nvim', 'gitlinker.nvim', 'playground', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'nvim-compe', 'lsp_signature.nvim', 'nvim-ts-autotag'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
