...
function M.setup()
  local config = { -- your config
    virtual_text = lsp_cfg.diagnostics.virtual_text,
    signs = lsp_cfg.diagnostics.signs,
    underline = lsp_cfg.diagnostics.underline,
    update_in_insert = lsp_cfg.diagnostics.update_in_insert,
    severity_sort = lsp_cfg.diagnostics.severity_sort,
    float = lsp_cfg.diagnostics.float,
  }
